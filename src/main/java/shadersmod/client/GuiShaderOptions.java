...
public class GuiShaderOptions extends GuiScreenOF {
    ...
    public static CFontRenderer font = Fonts.default18;
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(201, this.width / 2 - j1 - 20, this.height / 6 + 168 + 11, j1, k1, I18n.format("controls.reset")));
        this.buttonList.add(new GuiExButton(200, this.width / 2 + 20, this.height / 6 + 168 + 11, j1, k1, I18n.format("gui.done")));
    }
    ...
    public static String getButtonText(ShaderOption so, int btnWidth) {
        ...
        if (so instanceof ShaderOptionScreen) {
            ...
            for (int i = font.getStringWidth(": " + Lang.getOff()) + 5; font.getStringWidth(s) + i >= btnWidth && s.length() > 0; s = s.substring(0, s.length() - 1)) {
                ;
            }
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        if (this.screenText != null) {
            font.drawCenteredString(this.screenText, this.width / 2F, 15, 16777215);
        } else {
