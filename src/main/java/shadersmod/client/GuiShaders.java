...
public class GuiShaders extends GuiScreen {
    ...
    public CFontRenderer font = Fonts.default18;
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(201, j1 / 4 - k1 / 2, this.height - 25, k1, j, Lang.get("of.options.shaders.shadersFolder")));
        this.buttonList.add(new GuiExButton(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.format("gui.done")));
        this.buttonList.add(new GuiExButton(203, k, this.height - 25, i, j, Lang.get("of.options.shaders.shaderOptions")));
        this.updateButtons();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (i < this.width - 5) {
            font.drawCenteredString(s, this.width / 2, this.height - 40, 8421504);
        } else {
            font.drawString(s, 5, this.height - 40, 8421504);
        }
