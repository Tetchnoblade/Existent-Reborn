...
public class GuiScreenOF extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 1) {
            GuiExButton guibutton = getSelectedButton(this.buttonList, mouseX, mouseY);
    ...
    public static GuiExButton getSelectedButton(List<GuiButton> p_getSelectedButton_0_, int p_getSelectedButton_1_, int p_getSelectedButton_2_) {
        for (int i = 0; i < p_getSelectedButton_0_.size(); ++i) {
            GuiExButton guibutton = (GuiExButton) p_getSelectedButton_0_.get(i);
