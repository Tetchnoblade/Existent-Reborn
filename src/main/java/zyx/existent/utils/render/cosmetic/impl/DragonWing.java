package zyx.existent.utils.render.cosmetic.impl;
...
import zyx.existent.utils.render.cosmetic.Cosmetic;

public class DragonWing extends ModelBase implements MCUtil {
    ...
    public static void render(EntityPlayer player, float partialTicks) {
        ...
        GL11.glTranslated(0.0D, 0.1D, 0.2D);
        if (player.isSneaking() || Existent.getModuleManager().isEnabled(Sneak.class))
