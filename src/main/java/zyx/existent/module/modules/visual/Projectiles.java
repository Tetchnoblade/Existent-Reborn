...
public class Projectiles extends Module {
    ...
    public void onRender3D(EventRender3D event) {
        if (mc.thePlayer.inventory.getCurrentItem() != null) {
            ...
            int itemMain = Item.getIdFromItem(mc.thePlayer.getHeldItem(EnumHand.MAIN_HAND).getItem());
            int itemOff = Item.getIdFromItem(mc.thePlayer.getHeldItem(EnumHand.OFF_HAND).getItem());
