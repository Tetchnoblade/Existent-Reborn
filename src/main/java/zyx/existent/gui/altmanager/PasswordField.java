   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         if (this.getEnableBackgroundDrawing()) {
            RenderingUtils.drawRect(this.xPos, this.yPos + 1.4, this.xPos + this.width, this.yPos + this.height - 1.0, Colors.getColor(new Color(40, 35, 35, 255)));
            RenderingUtils.drawRect(this.xPos - 2.0, this.yPos + this.height - 0.4, this.xPos + this.width + 2.0, this.yPos + this.height, Colors.getColor(new Color(255, 255, 255)));
            RenderingUtils.drawRect(this.xPos - 2.0, this.yPos + 0.4, this.xPos + this.width + 2.0, this.yPos, Colors.getColor(new Color(255, 255, 255)));
         }
