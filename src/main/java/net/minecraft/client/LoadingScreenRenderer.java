...
public class LoadingScreenRenderer implements IProgressUpdate {
    ...
    private final CFontRenderer fonts = Fonts.default18;
    ...
    public void setLoadingProgress(int progress) {
        if (!this.mc.running) {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                RenderingUtils.drawRect(0, 0, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), new Color(50, 45, 45, 255).getRGB());
                ...
                fonts.drawStringWithShadow(this.currentlyDisplayedText, (float) ((k - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2), (float) (l / 2 - 4 - 16), 16777215);
                fonts.drawStringWithShadow(this.message, (float) ((k - this.mc.fontRendererObj.getStringWidth(this.message)) / 2), (float) (l / 2 - 4 + 8), 16777215);
