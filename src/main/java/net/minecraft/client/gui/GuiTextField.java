...
public class GuiTextField extends Gui {
    ...
    public String text = "";
    public int maxStringLength = 999;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderingUtils.drawRect(this.xPosition, this.yPosition + 1.4, this.xPosition + this.width, this.yPosition + this.height - 1.0, Colors.getColor(new Color(40, 35, 35, 255)));
                RenderingUtils.drawRect(this.xPosition - 2.0, this.yPosition + this.height - 0.4, this.xPosition + this.width + 2.0, this.yPosition + this.height, Colors.getColor(new Color(255, 255, 255)));
                RenderingUtils.drawRect(this.xPosition - 2.0, this.yPosition + 0.4, this.xPosition + this.width + 2.0, this.yPosition, Colors.getColor(new Color(255, 255, 255)));
            }
