...
public class GuiCreateWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("selectWorld.create")));
        this.buttonList.add(new GuiExButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel")));
        this.btnGameMode = this.addButton(new GuiExButton(2, this.width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode")));
        this.btnMoreOptions = this.addButton(new GuiExButton(3, this.width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions")));
        this.btnMapFeatures = this.addButton(new GuiExButton(4, this.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures")));
        this.btnMapFeatures.visible = false;
        this.btnBonusItems = this.addButton(new GuiExButton(7, this.width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems")));
        this.btnBonusItems.visible = false;
        this.btnMapType = this.addButton(new GuiExButton(5, this.width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.mapType")));
        this.btnMapType.visible = false;
        this.btnAllowCommands = this.addButton(new GuiExButton(6, this.width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands")));
        this.btnAllowCommands.visible = false;
        this.btnCustomizeType = this.addButton(new GuiExButton(8, this.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType")));
