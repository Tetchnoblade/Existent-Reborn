...
public class GuiScreenServerList extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.format("selectServer.select")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawCenteredString(I18n.format("selectServer.direct"), this.width / 2F, 20, 16777215);
        font.drawString(I18n.format("addServer.enterIp"), this.width / 2F - 100, 100, 10526880);
