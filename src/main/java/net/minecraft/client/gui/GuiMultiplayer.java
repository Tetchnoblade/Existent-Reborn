...
public class GuiMultiplayer extends GuiScreen {
    ...
    public void createButtons() {
        this.btnEditServer = this.addButton(new GuiExButton(7, this.width / 2 - 154, this.height - 28, 70, 20, "Edit"));
        this.btnDeleteServer = this.addButton(new GuiExButton(2, this.width / 2 - 74, this.height - 28, 70, 20, "Delete"));
        this.btnSelectServer = this.addButton(new GuiExButton(1, this.width / 2 - 154, this.height - 52, 100, 20, "Join Server"));
        this.buttonList.add(new GuiExButton(4, this.width / 2 - 50, this.height - 52, 100, 20, "Direct Connect"));
        this.buttonList.add(new GuiExButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, "Add Server"));
        this.buttonList.add(new GuiExButton(8, this.width / 2 + 4, this.height - 28, 70, 20, "Refresh"));
        this.buttonList.add(new GuiExButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, "Cancel"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawCenteredString(I18n.format("multiplayer.title"), this.width / 2F, 7, 16777215);
        font.drawCenteredString("User : " + mc.getSession().getUsername(), this.width / 2F, 19, 16777215);
