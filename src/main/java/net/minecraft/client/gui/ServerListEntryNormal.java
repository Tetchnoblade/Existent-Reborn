...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    ...
    public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
        ...
        font.drawString(this.server.serverName, p_192634_2_ + 32 + 3, p_192634_3_ + 1, 16777215);
        List<String> list = font.listFormattedStringToWidth(this.server.serverMOTD, p_192634_4_ - 32 - 2);

        for (int i = 0; i < Math.min(list.size(), 2); ++i) {
            font.drawString(list.get(i), p_192634_2_ + 32 + 3, p_192634_3_ + 12 + font.getHeight() * i, 8421504);
        }

        String s2 = flag2 ? TextFormatting.DARK_RED + this.server.gameVersion : this.server.populationInfo;
        int j = font.getStringWidth(s2);
        font.drawString(s2, p_192634_2_ + p_192634_4_ - j - 15 - 2, p_192634_3_ + 1, 8421504);
        int k = 0;
        String s = null;
        int l;
        String s1;
