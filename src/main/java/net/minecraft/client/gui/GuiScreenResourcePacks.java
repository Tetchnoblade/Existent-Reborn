...
public class GuiScreenResourcePacks extends GuiScreen {
    ...
    public void initGui() {
        this.buttonList.add(new GuiExOptionButton(2, this.width / 2 - 154, this.height - 48, I18n.format("resourcePack.openFolder")));
        this.buttonList.add(new GuiExOptionButton(1, this.width / 2 + 4, this.height - 48, I18n.format("gui.done")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawCenteredString(I18n.format("resourcePack.title"), this.width / 2F, 16, 16777215);
        font.drawCenteredString(I18n.format("resourcePack.folderInfo"), this.width / 2F - 77, this.height - 26, 8421504);
