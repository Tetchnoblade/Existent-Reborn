...
public abstract class GuiSlot {
    ...
    public final CFontRenderer font = Fonts.default18;
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks) {
        if (this.visible) {
            ...
            int j = i + 6;
            RenderingUtils.drawRect(this.left, 0, this.right, this.height, new Color(30, 25, 25, 255).getRGB());
            this.bindAmountScrolled();
            ...
            if (j1 > 0) {
                ...
                RenderingUtils.drawRect(i, this.bottom, j, this.top, new Color(20, 20, 20, 255).getRGB());
                RenderingUtils.drawRoundedRect(i, l1, j, l1 + k1, 2, new Color(128, 128, 128, 255).getRGB());
            }

            this.func_192638_a(k, l, mouseXIn, mouseYIn, partialTicks);
            GlStateManager.disableDepth();
            RenderingUtils.drawRect(this.left, this.top, this.right, 0, new Color(50, 45, 45, 255).getRGB());
            RenderingUtils.drawRect(this.left, this.top, this.right, this.top - 1.5, new Color(60, 55, 55, 255).getRGB());
            RenderingUtils.drawRect(this.left, this.height, this.right, this.bottom, new Color(50, 45, 45, 255).getRGB());
            RenderingUtils.drawRect(this.left, this.bottom, this.right, this.bottom + 1.5, new Color(60, 55, 55, 255).getRGB());
    ...
    protected void func_192638_a(int p_192638_1_, int p_192638_2_, int p_192638_3_, int p_192638_4_, float p_192638_5_) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (this.showSelectionBox && this.isSelected(j)) {
                ...
                GlStateManager.disableTexture2D();
                RenderingUtils.drawRect(i1 - 1, k - 2, j1 + 1, k + l + 2, new Color(60, 55, 55, 255).getRGB());
                RenderingUtils.drawRect(i1, k - 1, j1, k + l + 1, new Color(50, 45, 45, 255).getRGB());
                GlStateManager.enableTexture2D();
            }
