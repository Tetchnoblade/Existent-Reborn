...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(0, this.width / 2 - 100, this.height / 4 + 96 + 18, I18n.format("addServer.add")));
        this.buttonList.add(new GuiExButton(1, this.width / 2 - 100, this.height / 4 + 120 + 18, I18n.format("gui.cancel")));
        this.serverResourcePacks = this.addButton(new GuiExButton(2, this.width / 2 - 100, this.height / 4 + 72, I18n.format("addServer.resourcePack") + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawCenteredString(I18n.format("addServer.title"), this.width / 2F, 17, 16777215);
        font.drawString(I18n.format("addServer.enterName"), this.width / 2F - 100, 53, 10526880);
        font.drawString(I18n.format("addServer.enterIp"), this.width / 2F - 100, 94, 10526880);
