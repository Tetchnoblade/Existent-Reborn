...
public class GuiWorldSelection extends GuiScreen {
    ...
    public void postInit() {
        this.selectButton = this.addButton(new GuiExButton(1, this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select")));
        this.addButton(new GuiExButton(3, this.width / 2 + 4, this.height - 52, 150, 20, I18n.format("selectWorld.create")));
        this.renameButton = this.addButton(new GuiExButton(4, this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.edit")));
        this.deleteButton = this.addButton(new GuiExButton(2, this.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete")));
        this.copyButton = this.addButton(new GuiExButton(5, this.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate")));
        this.addButton(new GuiExButton(0, this.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawCenteredString(this.title, this.width / 2, 20, 16777215);
