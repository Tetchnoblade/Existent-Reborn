...
public class GuiKeyBindingList extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls controls, Minecraft mcIn) {
        ...
        for (KeyBinding keybinding : akeybinding) {
            ...
            int j = font.getStringWidth(I18n.format(keybinding.getKeyDescription()));
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry {
        ...
        public CategoryEntry(String name) {
            ...
            this.labelWidth = font.getStringWidth(this.labelText);
        }

        public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
            font.drawString(this.labelText, GuiKeyBindingList.this.mc.currentScreen.width / 2F - this.labelWidth / 2F, p_192634_3_ + p_192634_5_ - font.getHeight() - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry {
        ...
        private final GuiExButton btnChangeKeyBinding;
        private final GuiExButton btnReset;

        private KeyEntry(KeyBinding name) {
            this.keybinding = name;
            this.keyDesc = I18n.format(name.getKeyDescription());
            this.btnChangeKeyBinding = new GuiExButton(0, 0, 0, 75, 20, I18n.format(name.getKeyDescription()));
            this.btnReset = new GuiExButton(0, 0, 0, 50, 20, I18n.format("controls.reset"));
        }

        public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
            boolean flag = GuiKeyBindingList.this.controlsScreen.buttonId == this.keybinding;
            font.drawString(this.keyDesc, p_192634_2_ + 90 - GuiKeyBindingList.this.maxListLabelWidth, p_192634_3_ + p_192634_5_ / 2F - font.getHeight() / 2F, 16777215);
