...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void onDisconnect(ITextComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiExMainMenu()), "disconnect.lost", reason));
        }
    }

    public void sendPacket(Packet<?> packetIn) {
        EventPacketSend eventPacketSent = new EventPacketSend(packetIn);
        eventPacketSent.call();
