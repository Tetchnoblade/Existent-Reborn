...
public class ItemRenderer {
    ...
    private void transformFirstPersonItem(final float equipProgress, final float swingProgress) {
        ...
        if (!flag) {
            ...
            // rorate
//            GlStateManager.rotate(l, 0.01f, 0.0f, 0.0f);
        }
    ...
    private void transformFirstPersonItem2(final float equipProgress, final float swingProgress) {
        ...
        if (!flag) {
            ...
            // rotate
//            GlStateManager.rotate(l, 0.0f, 0.0f, 0.1f);
        }
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    float var17 = MathHelper.sin(f2 * f2 * 15.1415925F);
                        ...
                        if ((Boolean) animations.getSetting(Animations.OLDANIM).getValue() && (mc.gameSettings.keyBindUseItem.isKeyDown() || mc.thePlayer.isBlocking()) && p_187457_1_.getActiveItemStack().getItem() instanceof ItemShield && p_187457_1_.getActiveHand() == EnumHand.OFF_HAND) {
                            switch (((Options) animations.getSetting(Animations.MODE).getValue()).getSelected()) {
                                case "1.7":
                                    ...
                                    break;
                                case "Mini":
                                    this.transformFirstPersonItem2(0.0F, swingprogress);
                                    this.func_178103_c();
                                    break;
                                case "MiniJump":
                                ...
                                case "Helium":
                                    ...
                                    this.func_178103_c();
                                    GlStateManager.rotate(var17 * 80.0F, -120.0F, -104.4F, -120.0F);
                                    break;
                                case "Exhibobo":
                                    this.transformFirstPersonItem(0.0F, f / 2.0F);
                                    GL11.glRotatef(-var9 * 40.0F / 2.0F, var9 / 2.0F, -0.0F, 9.0F);
                                    GL11.glRotatef(-var9 * 30.0F, 2.0F, var9 / 2.0F, -0.0F);
                                    this.func_178103_c();
                                    break;
                                case "Pump":
