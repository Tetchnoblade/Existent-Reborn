...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        Entity entity = this.mc.getRenderViewEntity();
        ExtendedReach reach = (ExtendedReach) Existent.getModuleManager().getClazz(ExtendedReach.class);

        if (entity != null && this.mc.theWorld != null) {
            this.mc.mcProfiler.startSection("pick");
            this.mc.pointedEntity = null;
            double d0 = reach.isEnabled() ? reach.getReach() : this.mc.playerController.getBlockReachDistance();
            ...
            if (this.pointedEntity != null && flag && vec3d.distanceTo(vec3d3) > (reach.isEnabled() ? reach.getReach() : 3.0D)) {
                this.pointedEntity = null;
    ...
    private void hurtCameraEffect(float partialTicks) {
        Hurtcam hurtcam = (Hurtcam) Existent.getModuleManager().getClazz(Hurtcam.class);
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            GlStateManager.rotate(hurtcam.isEnabled() ? -f * ((Number) hurtcam.getSetting(Hurtcam.HURTANGLE).getValue()).floatValue() : -f * 14.0F, 0.0F, 0.0F, 1.0F);
            GlStateManager.rotate(f2, 0.0F, 1.0F, 0.0F);
        }
    }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (raytraceresult != null) {
                        ...
                        //TODO ViewClip
                        if (d7 < d3 && !Existent.getModuleManager().isEnabled(ViewClip.class)) {
                            d3 = d7;
                        }
                    }
                }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        EventRender3D render3D = new EventRender3D(partialTicks, 0, 0, 0);
        render3D.call();
    ...
    private void frameInit() {
        ...
        if (world != null) {
            //TODO Optifine VersionNotification
