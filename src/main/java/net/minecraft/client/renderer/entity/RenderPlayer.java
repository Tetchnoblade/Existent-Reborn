...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer> {
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!entity.isUser() || this.renderManager.renderViewEntity == entity) {
            ...
            if (entity.isSneaking() || (entity == Minecraft.getMinecraft().thePlayer &&Existent.getModuleManager().isEnabled(Sneak.class))) {
                d0 = y - 0.125D;
            }
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
        ...
        if (clientPlayer.isSpectator()) {
            ...
            modelplayer.isSneak = clientPlayer.isSneaking() || (clientPlayer == Minecraft.getMinecraft().thePlayer && Existent.getModuleManager().isEnabled(Sneak.class));
