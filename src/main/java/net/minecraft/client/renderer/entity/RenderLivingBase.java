...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, partialTicks, x, y, z)) {
            EventBodyRender eventpreBodyRender = new EventBodyRender(entity, this, true);
            EventBodyRender eventpostBodyRender = new EventBodyRender(entity, false);
            eventpreBodyRender.call();
            ...
            try {
                ...
                float f7 = (entity instanceof EntityPlayer && entity == Minecraft.getMinecraft().thePlayer) ? entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks : entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks ;
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        Outline outline = (Outline) Existent.getModuleManager().getClazz(Outline.class);
        boolean flag2 = (chams.isEnabled() && entitylivingbaseIn instanceof EntityPlayer && (Boolean) chams.getSetting(Chams.ENTITY).getValue());
        boolean flag3 = (outline.isEnabled() && entitylivingbaseIn instanceof EntityPlayer);
        String currentmode = ((Options) chams.getSetting(Chams.MODE).getValue()).getSelected();
        ...
        if (flag || flag1) {
            ...
            if (flag2) {
                switch (currentmode) {
                    case "Fill":
                        ...
                        GL11.glColor4f(255 / 255.0F, 150 / 255.0F, 50 / 255.0F, 255 / 255.0F);
                        GL11.glDisable(2929);
            ...
            if (flag3) {
                OutlineUtils.disableFastRender();
                GlStateManager.resetColor();
                final Color color = entitylivingbaseIn.hurtTime >= 1 ? new Color(255, 50, 50) : new Color(255, 255, 255);
                OutlineUtils.renderOne(((Number) outline.getSetting(Outline.WIDTH).getValue()).floatValue());
            ...
            if (flag2) {
                switch (currentmode) {
                    case "Fill":
                        ...
                        GL11.glColor4f(255 / 255.0F, 200 / 255.0F, 100 / 255.0F, 255 / 255.0F);
                        this.mainModel.render(entitylivingbaseIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
                        GL11.glEnable(3553);
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            if (flag1) {
                this.brightnessBuffer.put(1.0F); // red
                this.brightnessBuffer.put(0.0F); // green
                this.brightnessBuffer.put(0.0F); // blue
                this.brightnessBuffer.put(0.3F); // alpha
