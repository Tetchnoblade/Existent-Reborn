...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
    ...
    public void func_192841_a(TileEntityChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_) {
        ...
        if (p_192841_1_.adjacentChestZNeg == null && p_192841_1_.adjacentChestXNeg == null) {
            ...
            ChestESP chestESP = (ChestESP) Existent.getModuleManager().getClazz(ChestESP.class);
            boolean flag1 = chestESP.isEnabled();
            String currentmode = ((Options) chestESP.getSetting(ChestESP.MODE).getValue()).getSelected();
            ...
            if (flag1) {
                switch (currentmode) {
                    case "Fill":
                        ...
                        GL11.glColor4f(255 / 255.0F, 50 / 255.0F, 50 / 255.0F, 100 / 255.0F);
                        GL11.glDisable(2929);
            ...
            if (flag1) {
                switch (currentmode) {
                    case "Fill":
                        ...
                        GL11.glColor4f(255 / 255.0F, 70 / 255.0F, 70 / 255.0F, 255 / 255.0F);
                        modelchest.renderAll();
                        GL11.glEnable(3553);
