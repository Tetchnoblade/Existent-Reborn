...
public class GuiConnecting extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiExButton(0, this.width / 2 - 100, this.height / 4 + 120 + 12, I18n.format("gui.cancel")));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.networkManager == null) {
            font.drawCenteredString(I18n.format("connect.connecting"), this.width / 2F, this.height / 2F - 50, 16777215);
        } else {
            font.drawCenteredString(I18n.format("connect.authorizing"), this.width / 2F, this.height / 2F - 50, 16777215);
        }
